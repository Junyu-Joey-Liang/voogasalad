...
public class TestData {
    private final String NAME = "testData";
    private final String DESCRIPTION = "testData description";
    private final String IMAGE_PATH = "testData imagePath";
    private final String FILE_PATH = System.getProperty("user.dir") + "/data/test/" + NAME + ".xml";
    private final String UNKNOWN_FILE_PATH = System.getProperty("user.dir") + "/data/test/unknown_unknown.xml";
    private final String LEVEL_NAME = "Level1";
    private final String ATTACKER_NAME = "Attacker1";
    private final String DEFENDER_NAME = "Defender1";
    private final String PROJECTILE_NAME = "Projectile1";
    private final String MAP_NAME = "Map1";
